...
class Renderer:
  ...
  def __init_attributes(self):
    ...
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/robot_ground_stand.png"),transparency_mask = enemy_ground_mask))
    enemy_ground_mask = pygame.image.load("resources/robot_ground_right_mask.bmp")
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/robot_ground_right.png"),transparency_mask = enemy_ground_mask))
    enemy_ground_mask = pygame.image.load("resources/robot_ground_left_mask.bmp")
    self.enemy_ground_images.append(prepare_image(pygame.image.load("resources/robot_ground_left.png"),transparency_mask = enemy_ground_mask))
    ...
    self.teleport_active_image = prepare_image(pygame.image.load("resources/teleport_2.png"),transparency_mask = teleport_mask)
    logo_mask = pygame.image.load("resources/logo_mask.png")
    self.logo_image = prepare_image(pygame.image.load("resources/logo.bmp"), transparency_mask = logo_mask)
    ...
    coin_mask = pygame.image.load("resources/coin_1_mask.bmp")
    self.coin_images.append(prepare_image(pygame.image.load("resources/coin_1.bmp"),transparency_mask = coin_mask))
    ...
    self.player_images.moving_right.append(prepare_image(pygame.image.load("resources/duck_right_walk.bmp"),transparency_mask = pygame.image.load("resources/duck_right_walk_mask.bmp")))
...
class Game:
  ...
  def __init__(self, name, fullscreen, sound):
    ...
    pygame.display.set_caption("Aliens Game (Mohadeseh Javadian)")
    ...
    self.menu_about.text_lines.append("Mohadeseh Javadian, 2024")
    ...
    self.menu_about.text_lines.append("get all hearts and send to your love")
